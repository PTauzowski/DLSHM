...
from dlimages.data_processing import ICSHM_RGB_4_Converter, ICSHMDataManager
from dlmodels.loss_functions import weighted_categorical_crossentropy

import pandas as pd
#from dlshm.dlimages.convert import
from dlmodels.trainer import DLTrainer
from dlmodels.custom_models import DeeplabV3Plus
from dlgenerators.generators import DataSource, DataGeneratorFromNumpyFiles
import tensorflow as tf
from skimage.transform import resize
from keras_unet.models import custom_unet
import pandas as pd
import matplotlib as mpl
from dlimages.augmentations import augment_all
from dlimages.postprocess import write_prediction_segmentated2, test_dmg_segmentation
import numpy as np
...
TASK_PATH = "/home/djb/djb/prj/tib_pan/DLSHM/data/Tokaido_dataset"
TRAIN_IMAGES_PATH = TASK_PATH + '/' + 'DL4SHM_trainSet'
MODEL_PATH = TASK_PATH + '/' + CURRENT_MODEL_NAME
IMAGES_SOURCE_PATH = '/home/djb/djb/prj/tib_pan/DLSHM/data/Tokaido_dataset'
...
# model = DeepLabV3((RES_Y, RES_X, N_CHANNELS), N_CLASSES)
