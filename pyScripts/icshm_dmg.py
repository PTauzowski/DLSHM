...
train_pathDMG = os.path.join(task_path, 'TrainSets/DMGbig')
DMGmodel_name='ICSHM_DMGbig_DeepLabV3at_E100'
...
data_manager.convert_data_to_numpy_format(imgDMG_conv, train_pathDMG)
